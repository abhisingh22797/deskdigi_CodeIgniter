...
class Training_model extends CI_Model
{
 ...
 function deletetraining($sId, $sliderInfo)
    ...
    function gettrainingById($id){
        ...
        $this->db->select('tbl_training_options.*,tbl_course_category.cat_name')
   ...
   public function training_data() {        
        ...
        $SQL =  "SELECT tbl_training_options.*,tbl_course_category.cat_name FROM (tbl_training_options JOIN tbl_course_category ON tbl_training_options.cat_id=tbl_course_category.id) WHERE tbl_training_options.status='Active' AND tbl_course_category.status='Active'";    
