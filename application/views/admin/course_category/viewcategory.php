        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>admin/course_category/addcategory"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div>
        <div class="row">
...
jQuery(document).ready(function(){
	...
	jQuery(document).on("click", ".deletecategory", function(){
		var sid = $(this).data("sid"),
			hitURL = baseURL + "admin/course_category/deletecategory/",
			currentRow = $(this);
...
<script>
  var table = $('#category').dataTable( { 
		...
		ajax: {
            url: "<?=base_url('admin/course_category/datatable_json')?>",
            type: "GET"
        },
		processing: true,
		serverSide: true, 
        ...
        { "targets": 1, "name": "date_created", 'searchable':true, 'orderable':true},
        { "targets": 2, "name": "date_modified", 'searchable':true, 'orderable':true},
