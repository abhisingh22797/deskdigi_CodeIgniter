...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i>Conversation Optimaization
            <small>Edit</small>
        </h1>
    </section>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter Conversation Optimaization Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <?php
                    $attributes = array('id' => 'editstudentplacement', 'method' => 'post', 'class' => 'form_horizontal');
                    echo form_open_multipart('admin/Student_placement/editstudentplacement', $attributes);
                    ?>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="slid_subtitle1">subtitle</label>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="slid_img1">sec_1 image</label>
                                    <input type="file" class="form-control required" id="banner_image" name="slid_img1">
                                    <img src="<?php echo  base_url(); ?>uploads/student/<?php echo $allData->slid_img1; ?>" height="100px" width="200px">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="slid_title2">Sec 1 description1</label>

                                    <textarea rows="10" col="8" id="slid_title2" class="form-control" name="slid_title2"><?php echo $allData->slid_title2; ?></textarea>
                                </div>
                            </div>

                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="pdes">Sec 1 description2</label>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="slid_img2">Sec 2 image</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="slid_title2">Sec 2 title</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="p1">Sec 2 Description</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="pi1">Sec_3 image</label>
                                    <input type="file" class="form-control required" id="banner_image" name="pi1">
                                    <img src="<?php echo  base_url(); ?>uploads/student/<?php echo $allData->pi1; ?>" height="100px" width="200px">
                                </div>
                            </div>

                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="p2">Sec_3 title</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="p3">Sec_3 description</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="pi2">Sec 4 images</</label> <input type="file" class="form-control required" id="banner_image" name="pi2">
                                        <img src="<?php echo  base_url(); ?>uploads/student/<?php echo $allData->pi2; ?>" height="100px" width="200px">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="p3">Sec 4 title</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="p5">Sec 4 Description</label>
                            ...
                            <!--  <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <img src="<?php echo  base_url(); ?>uploads/student/<?php echo $allData->pi3; ?>" height="100px" width="200px">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <img src="<?php echo  base_url(); ?>uploads/student/<?php echo $allData->pi4; ?>" height="100px" width="200px">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <img src="<?php echo  base_url(); ?>uploads/student/<?php echo $allData->pi5; ?>" height="100px" width="200px">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <img src="<?php echo  base_url(); ?>uploads/student/<?php echo $allData->pi6; ?>" height="100px" width="200px">
                                </div>
                            </div>
                        </div>
                        <div class="row">
