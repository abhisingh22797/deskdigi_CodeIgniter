        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>admin/blogs/addTestimonials"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div>
        <div class="row">
...
jQuery(document).ready(function(){
	...
	jQuery(document).on("click", ".deleteTestimonial", function(){
		var tid = $(this).data("tid"),
			hitURL = baseURL + "admin/Blogs/deleteTestimonials/",
			currentRow = $(this);
