                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php foreach ($training_dataa as $img) : ?>
                                         <div class="form-group" id="tr<?= $img['id']?>">
                                            <img src="<?php echo base_url() . 'uploads/Hiring Companies/' . $img['c_image']; ?>" width="100" height="80"> <a class="delete" onclick="deletedata('tbl_benefit_img','id','<?= $img['id']?>')" ><i class="fa fa-trash"></i></a>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <img src="<?php echo base_url() . 'uploads/salary/' . $training_data['sal_image']; ?>" width="100" height="80">
                                    </div>
                                </div>
