<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i>Training options
        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>admin/trainingoptions/addtrainingoptions"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Training options List</h3>
                      <!--<div class="box-tools">
...
<script>
  var table = $('#training').dataTable( { 
		...
		ajax: {
            url: "<?=base_url('admin/trainingoptions/datatable_json')?>",
            type: "GET"
        },
		processing: true,
		serverSide: true, 
        ...
        { "targets": 1, "name": "c_title", 'searchable':true, 'orderable':true},
      
        { "targets": 2, "name": "date_created", 'searchable':false, 'orderable':true},
        { "targets": 3, "name": "date_updated", 'searchable':false, 'orderable':true},
        { "targets": 4, "name": "status", 'searchable':false, 'orderable':true},
