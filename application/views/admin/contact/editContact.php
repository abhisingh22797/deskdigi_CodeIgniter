                            ...
                            <div class="row">
								...
								<div class="col-md-4">                                
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php echo $allData->mobile; ?>" id="phone1" name="phone1" maxlength="128">
                                    </div>
								...
								<div class="col-md-4">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php echo $allData->google; ?>" id="google" name="google" >
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" col="8" id="address"  class="form-control" name="address"><?php  echo $allData->address; ?></textarea>
								...
								<div class="col-md-12">                                
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" col="8"  id="about_title" name="about_title"  class="form-control"><?php echo $allData->about_title; ?></textarea>
                                    </div>
                                    </div>
									<div class="col-md-6">                                
                                    <div class="form-group">
