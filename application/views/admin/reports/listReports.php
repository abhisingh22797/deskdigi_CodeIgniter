<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-file"></i> Contact Query Reports
        <small>View</small>
      </h1>
    </section>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery('ul.pagination li a').click(function (e) {
            ...
            jQuery("#searchList").attr("action", baseURL + "admin/reports/reportListing/" + value);
...
<script>
  var table = $('#reports_data').dataTable( { 
		...
		order: [[0, "asc"]],		
		columns: [
        { "targets": 0, "name": "fname", 'searchable':true, 'orderable':true},
        { "targets": 1, "name": "email", 'searchable':true, 'orderable':true},
        { "targets": 2, "name": "mobile", 'searchable':true, 'orderable':true},
		 { "targets": 2, "name": "message", 'searchable':true, 'orderable':true},
