                             ...
                             <div class="col-md-6">
								...
								<div class="col-md-4">
                                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php echo $slider['title_bottom']; ?>" id="title_bottom" name="title_bottom"  >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="title_upper">Title upper</label>
                                        <input type="text" class="form-control required" value="<?php echo $slider['title_upper']; ?>" id="title_upper" name="title_upper"  >
                                    </div>
                                </div>
								 ...
								 <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php echo $slider['links']; ?>" id="link" name="link"  >
                                    </div>
                                </div>
                            </div>
