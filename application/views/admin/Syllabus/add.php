...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Syllabus management
        <small>Add Syllabus</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter Syllabus Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <?php $this->load->helper("form"); ?>
					 <?php
				          $attributes = array('id' => 'addTestimonials','method' => 'post','class' => 'form_horizontal');
				          echo form_open_multipart('admin/Syllabus/addTestimonials', $attributes); 
					  ?>
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                               ...
                               <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="condtent">Syllabus Data</label>
