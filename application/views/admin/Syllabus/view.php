<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Syllabus
        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>admin/Syllabus/addTestimonials"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div>
        <div class="row">
...
jQuery(document).ready(function(){
	...
	jQuery(document).on("click", ".deleteTestimonial", function(){
		var tid = $(this).data("tid"),
			hitURL = baseURL + "admin/Syllabus/deleteTestimonials/",
			currentRow = $(this);
...
<script>
  var table = $('#testimonial').dataTable( { 
		...
		ajax: {
            url: "<?=base_url('admin/Syllabus/datatable_json')?>",
            type: "GET"
        },
		processing: true,
		serverSide: true, 
