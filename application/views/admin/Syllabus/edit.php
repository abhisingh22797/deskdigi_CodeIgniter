              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Edit Syllabus Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <?php $this->load->helper("form"); ?>
					  <?php
				          $attributes = array('id' => 'editTestimonials','method' => 'post','class' => 'form_horizontal');
				          echo form_open_multipart('admin/Syllabus/editTestimonials/', $attributes); 
					  ?>
                        ...
                        <div class="box-body"> 
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="conteent">Content</label>
