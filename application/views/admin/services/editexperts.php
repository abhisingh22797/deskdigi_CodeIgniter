        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    echo form_open_multipart('admin/brands/editexperts/', $attributes);
                    ?>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label for="tech">Description</label>
                              
<textarea rows="10" col="8" id="tech" class="form-control" name="tech"><?php echo $user["tech"];?></textarea>
                            </div>
