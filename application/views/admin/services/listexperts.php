    ...
    <div class="row">
      <div class="col-xs-12 text-right">
        <div class="form-group">
          <a class="btn btn-primary" href="<?php echo base_url(); ?>admin/brands/addexperts"><i class="fa fa-plus"></i> Add New</a>
        </div>
      </div>
    </div>
    <div class="row">
  ...
  jQuery(document).ready(function() {
    ...
    jQuery(document).on("click", ".deletebrands", function() {
      var bid = $(this).data("bid"),
        hitURL = baseURL + "admin/brands/deleteexpertss/",
        currentRow = $(this);
...
<script>
  var table = $('#brands').dataTable({
    ...
    ajax: {
      url: "<?= base_url('admin/brands/datatable_jsonee') ?>",
      type: "GET"
    },
    processing: true,
    serverSide: true,
