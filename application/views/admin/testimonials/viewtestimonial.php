        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>admin/testimonials/addTestimonialss"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
				  <table id="testimonial" class="table table-bordered table-striped">
                    <thead>
                    <tr>
                      <th>Author</th>
                        <th>Image</th>
...
jQuery(document).ready(function(){
	...
	jQuery(document).on("click", ".deleteTestimonial", function(){
		var tid = $(this).data("tid"),
			hitURL = baseURL + "admin/testimonials/deleteTestimonialss/",
			currentRow = $(this);
...
<script>
  var table = $('#testimonial').dataTable( { 
		...
		ajax: {
            url: "<?=base_url('admin/testimonials/datatable_jsone')?>",
            type: "GET"
        },
		processing: true,
		serverSide: true, 
		...
		order: [[0, "asc"]],		
		columns: [
        { "targets": 0, "name": "author", 'searchable':true, 'orderable':true},
        { "targets": 1, "name": "image", 'searchable':true, 'orderable':true},
        { "targets": 1, "name": "content", 'searchable':true, 'orderable':true},
        { "targets": 1, "name": "designation", 'searchable':true, 'orderable':true},
