 ...
 */
class Twss extends CI_Controller
{
    /**
    ...
    {
        parent::__construct();
   $this->load->model('frontend/Twss_model');
	...
	//    $data['test'] =  $this->home_model->getTestimonial();
		$data['contact'] =  $this->Twss_model->getContact();
	...
	//	$data['allSlider'] = $this->home_model->getAllSliders(); 
     //   $data['aboutInfo'] = $this->home_model->getAbout();	
      ...
      $data['program'] =  $this->Twss_model->allprogram(); 			
        $data['title'] = 'Fincore Analytics | TWSS CFA® Exam Result';
		$data['layout'] = 'Twss';
