...
class Service extends BaseController
{
    ...
    function serviceListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = 'Birjuflower Store: service Listing';
    ...
    function addNew()
    {
        ...
        {   $data['scat'] = $this->service_model->getServiceCat();
            $this->global['pageTitle'] = 'Birjuflower Store: Add New Service';
    ...
    function editOld($sId = NULL)
    {
            ...
            $this->global['pageTitle'] = 'Birjuflower Store : Edit Service';
    ...
    function editService()
    {
        ...
        else
        {
            ...
            else
            {
				...
				$serviceInfo = array('title'=>$catId,'description'=>$des, 'image'=>$image, 'updatedBy'=>1, 'date_updated'=>date('Y-m-d H:i:s'),'title'=>$name);
