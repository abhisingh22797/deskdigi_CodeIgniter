    ...
    $data["fetch_data"]= $this->Slider_model->sliderListing();
	 ...
	 if($this->isAdmin() == TRUE)
        ...
        {        
            ...
            $this->global['pageTitle'] = 'Birjuflower  : slider Listing';
 ...
 function sliderListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = 'Birjuflower : Gallery Listing';
...
function viewsliders(){
        ...
        {        
            ...
            $this->global['pageTitle'] = 'Fiesttech :slider';
  ...
  public function uploadfilesamenames($file,$tem)
  {
    ...
    function addSlider()
    {
...

        {
            ...
            $this->global['pageTitle'] = 'Fiesttech : Add New slider';
    ...
    if(  $this->input->post('submit')!==NULL){
			...
			//	 "img_bottom" =>  $img_bottom,   
                 ...
                 "title_bottom"=>  $this->input->post('title_bottom'),  
                   "title_upper"=>  $this->input->post('title_upper'),  
  ...
  function editslider($id =NULL ){
...

    {
        ...
        $formArray['title_bottom']= $this->input->post('title_bottom');
                $formArray['title_upper']= $this->input->post('title_upper');
                 $formArray['links']= $this->input->post('link');            
