...
class Testimonials extends BaseController
{
    ...
    function addTestimonials()
    {
        if ($this->isAdmin() == TRUE) {
            ...
            $this->global['pageTitle'] = 'Deskdigi: Add New Testimonial';
    ...
    function viewtestimonials()
    {
        ...
        if ($this->isAdmin() == TRUE) {
            ...
            $this->global['pageTitle'] = 'BirjuFlower Store :Testimonials';
    ...
    function addTestimonialss()
    {
        if ($this->isAdmin() == TRUE) {
            ...
            $this->loadViews("admin/testimonials/addTestimonial", $this->global, $data, NULL);
            ...
            if ($this->input->post('submit') !== NULL) {
                ...
                $this->testimonial_model->inserttestimonials($forminput);
                $this->session->set_flashdata('success', 'record added successfully');
                redirect(base_url() . 'admin/testimonials/viewtestimonialss');
            }
        }
    }

    function viewtestimonialss()
    {
        ...
        if ($this->isAdmin() == TRUE) {
            ...
            $this->global['pageTitle'] = 'Deskdigi :Testimonials';
            ...
            $this->loadViews("admin/testimonials/viewtestimonial", $this->global, $data, NULL);
        }
    }

    function editTestimonialss($id = NULL)
    {
        ...
        if ($this->isAdmin() == TRUE) {
            ...
            $this->load->model("testimonial_model");
            $this->global['pageTitle'] = 'Deskdigi :Testimonials';
            $data['user'] = $this->testimonial_model->getTestbyIds($id);

            $this->loadViews("admin/testimonials/editTestimonial", $this->global, $data, NULL);
            ...
            if ($this->input->post('submit') !== NULL) {
                ...
                $this->testimonial_model->updatetestimonials($id, $formArray);
                $this->session->set_flashdata('success', 'record updated successfully');
                redirect(base_url() . 'admin/testimonials/viewtestimonialss');
            }
        }
    ...
    function deleteTestimonialss()
    {
        ...
        if ($this->isAdmin() == TRUE) {
            ...
            $result = $this->testimonial_model->deleteTestimonials($tid, $serviceInfo);
    ...
    {
        $records = $this->testimonial_model->testimonial_dataa();
        $data = array();
        foreach ($records['data']  as $row) {
            $image = '<img src="' . base_url() . 'uploads/testimonial/' . $row['image'] . '" width="100" height="80">';
            $data[] = array(
                ...
                '<a title="Edit/View" class="update btn btn-primary" href="' . base_url() . 'admin/testimonials/editTestimonialss/' . $row['id'] . '"> <i class="fa fa-pencil-square-o"></i></a>|<a class="btn btn-sm btn-danger deleteTestimonial" href="#" data-tid="' . $row['id'] . '" title="Delete"><i class="fa fa-trash"></i></a>',
