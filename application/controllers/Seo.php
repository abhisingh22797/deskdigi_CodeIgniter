...
class Seo extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('frontend/Gyan_model');
    ...
    public function index()
    {
        ...
        $data['contact'] =  $this->Gyan_model->getContact();
        ...
        $data['allHome'] = $this->Gyan_model->getHome();
        //  $data['allBarnds'] = $this->home_model->getBrands();
        // $data['promos'] = $this->home_model->getPromos();
        // $data['learnPath'] = $this->home_model->getLearning();
        $data['program'] =  $this->Gyan_model->allprogram();
        $data['syllabus'] =  $this->Gyan_model->allblogs();
        $data['title'] = 'Deskdigi| SEO';
        $data['layout'] = 'seo';
