...
class Social extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('frontend/Corporate_model');
    ...
    public function index()
    {
        ...
        $data['test'] =  $this->Corporate_model->getTestimonial();
        $data['contact'] =  $this->Corporate_model->getContact();
        //  $data['program'] =  $this->Corporate_model->allprogram();
        ...
        $data['allplace'] = $this->Corporate_model->getplace();

        $data['title'] = 'Deskdigi | social media marketing';
        $data['layout'] = 'Social_Media_Marketing';
